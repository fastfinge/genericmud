...
# but spec-compliant servers still gate those tags behind DO MSP, so it has to be here.
...
_ACCEPT_REMOTE = frozenset(
    {T.OPT_MCCP2, T.OPT_GMCP, T.OPT_MSDP, T.OPT_MSSP, T.OPT_MSP, T.OPT_EOR, T.OPT_SGA}
)

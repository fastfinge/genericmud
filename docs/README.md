...
This folder holds the longer guides that do not fit comfortably in the main
README. The files are ordinary Markdown, so GitHub displays them as web pages
and keeps each change with the version of genericMud it describes.
